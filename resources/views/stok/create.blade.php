<x-layouts.dashboard>
    <x-slot name="header">Yeni Stok Kartı</x-slot>
    ...
    <div class="flex items-center gap-4 mb-6">
        ...
        <div>
            <h1 class="text-2xl font-bold text-slate-800">Yeni Stok Kartı</h1>
            <p class="text-slate-500 mt-1">Sisteme yeni bir stok kalemi ekleyin</p>
        </div>
    </div>

    <!-- Form -->
    <form action="{{ route('stok.store') }}" method="POST" class="space-y-6 pb-12">
        @csrf
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="STOKKOD" name="STOKKOD" value="{{ old('STOKKOD') }}" required
                ...
                <div>
                    ...
                    <input type="text" id="ETICARETKOD" name="ETICARETKOD" value="{{ old('ETICARETKOD') }}"
                ...
                <div class="lg:col-span-2">
                    ...
                    <input type="text" id="STOKADI" name="STOKADI" value="{{ old('STOKADI') }}" required
                ...
                <div>
                    ...
                    <input type="text" id="STOKADI_PRKND" name="STOKADI_PRKND" value="{{ old('STOKADI_PRKND') }}"
                        class="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                </div>
            </div>
        </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" id="STOKGRP1" name="STOKGRP1" value="{{ old('STOKGRP1') }}"
                            class="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                    <div>
                        <label for="STOKGRP2" class="block text-sm font-medium text-slate-700 mb-1">Grup 2</label>
                        <input type="text" id="STOKGRP2" name="STOKGRP2" value="{{ old('STOKGRP2') }}"
                            class="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input type="text" id="STBIRIM" name="STBIRIM" value="{{ old('STBIRIM', 'ADET') }}"
                            class="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                    <div>
                        <label for="STBIRIM2" class="block text-sm font-medium text-slate-700 mb-1">Birim 2</label>
                        <input type="text" id="STBIRIM2" name="STBIRIM2" value="{{ old('STBIRIM2') }}"
                            class="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                    <div>
                        <label for="STBIRIM2KATSAYI" class="block text-sm font-medium text-slate-700 mb-1">Kayıt Katsayısı</label>
                        <input type="number" step="any" id="STBIRIM2KATSAYI" name="STBIRIM2KATSAYI" value="{{ old('STBIRIM2KATSAYI', 1) }}"
                            class="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                    <div>
                        <label for="STKRITIK" class="block text-sm font-medium text-slate-700 mb-1">Kritik Stok</label>
                        <input type="number" step="any" id="STKRITIK" name="STKRITIK" value="{{ old('STKRITIK', 0) }}"
                            class="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div>
                    ...
                    <input type="number" step="any" id="STALISFIYAT" name="STALISFIYAT" value="{{ old('STALISFIYAT', 0) }}"
                        class="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="any" id="STSATISFIYAT1" name="STSATISFIYAT1" value="{{ old('STSATISFIYAT1', 0) }}"
                        class="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="any" id="STSATISFIYAT2" name="STSATISFIYAT2" value="{{ old('STSATISFIYAT2', 0) }}"
                        class="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="any" id="STISKONTO" name="STISKONTO" value="{{ old('STISKONTO', 0) }}"
                        class="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                ...
                <div>
                    ...
                    <select id="STKDV" name="STKDV" class="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                        <option value="0" {{ old('STKDV') == 0 ? 'selected' : '' }}>%0</option>
                        <option value="1" {{ old('STKDV') == 1 ? 'selected' : '' }}>%1</option>
                        <option value="10" {{ old('STKDV') == 10 ? 'selected' : '' }}>%10</option>
                        <option value="20" {{ old('STKDV', 20) == 20 ? 'selected' : '' }}>%20</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="any" id="STKDV2" name="STKDV2" value="{{ old('STKDV2', 0) }}"
                        class="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                </div>
            </div>
        </div>
