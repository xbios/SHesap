<x-layouts.dashboard>
    <x-slot name="header">Cari Düzenle</x-slot>
    ...
    <div class="flex items-center gap-4 mb-6">
        ...
        <div>
            <h1 class="text-2xl font-bold text-slate-800">Cari Düzenle</h1>
            <p class="text-slate-500 mt-1">{{ $cari->CRKOD }} - {{ $cari->CRISIM }}</p>
        </div>
    </div>

    <!-- Form -->
    <form action="{{ route('cari.update', $cari->CRID) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="CRKOD" name="CRKOD" value="{{ old('CRKOD', $cari->CRKOD) }}" required
                ...
                <div>
                    ...
                    <input type="text" id="CRISIM" name="CRISIM" value="{{ old('CRISIM', $cari->CRISIM) }}" required
                ...
                <div>
                    ...
                    <input type="text" id="CRYETKILI" name="CRYETKILI" value="{{ old('CRYETKILI', $cari->CRYETKILI) }}"
                ...
                <div>
                    ...
                    <input type="text" id="CRROTA" name="CRROTA" value="{{ old('CRROTA', $cari->CRROTA) }}"
                        class="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="CRADRES" name="CRADRES" rows="2"
                        class="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">{{ old('CRADRES', $cari->CRADRES) }}</textarea>
                </div>

                <!-- Şehir -->
                <div>
                    <label for="CRSEHIR" class="block text-sm font-medium text-slate-700 mb-1">Şehir</label>
                    <input type="text" id="CRSEHIR" name="CRSEHIR" value="{{ old('CRSEHIR', $cari->CRSEHIR) }}"
                        class="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                ...
                <div>
                    ...
                    <input type="email" id="CREMAIL" name="CREMAIL" value="{{ old('CREMAIL', $cari->CREMAIL) }}"
                ...
                <div>
                    ...
                    <input type="text" id="CRTEL" name="CRTEL" value="{{ old('CRTEL', $cari->CRTEL) }}"
                        class="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="CRTEL2" name="CRTEL2" value="{{ old('CRTEL2', $cari->CRTEL2) }}"
                        class="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="CRGSM" name="CRGSM" value="{{ old('CRGSM', $cari->CRGSM) }}"
                        class="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="CRVERGD" name="CRVERGD" value="{{ old('CRVERGD', $cari->CRVERGD) }}"
                        class="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="CRVERGNO" name="CRVERGNO" value="{{ old('CRVERGNO', $cari->CRVERGNO) }}"
                        class="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                </div>
            </div>
        </div>
